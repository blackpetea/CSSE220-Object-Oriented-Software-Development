...
public class StringLinkedList {
	...
	public void replaceString(String oldString, String newString) {
		Node test=this.first;
		while (test!=null) {
			if (test.data.equals(oldString)) {
				test.data=newString;
			}
			test=test.next;
		}
	...
	public void joinPairs() {
		...
		while (test!=null&&test.next!=null) {
			test.data=test.data+test.next.data;
	...
	public StringLinkedList copyList() {
		...
		Node res=new Node(first.data,null);
		Node test=this.first;
		Node newTest=res;
		while (test.next!=null) {
			newTest.next=new Node(test.next.data,null);
