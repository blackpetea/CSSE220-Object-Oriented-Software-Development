...
public class Exploder extends AbstractBouncer {
	...
	public void updateSize() {
		...
		if (new_r >= this.initialRadius * this.sizemulti) {
			...
			Exploder son_ball1 = new Exploder(super.getWorld(), this.radius / (1.5 * this.sizemulti),
					current_Center);
			Exploder son_ball2 = new Exploder(super.getWorld(), this.radius / (1.5 * this.sizemulti),
					current_Center);
