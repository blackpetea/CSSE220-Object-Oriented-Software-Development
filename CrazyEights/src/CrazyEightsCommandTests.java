...
public class CrazyEightsCommandTests {
	...
	public void testExitGame() {
		String[] expected = new String[] { "Cards dealt.", "Player 1, your turn.",
				"Your cards are QH JC 8S JD 10D 5H 3D", "The top discard is KC" };
	...
	public void testPlayCard() {
		String[] expected = new String[] { "Card JC played.", "Player 2, your turn.",
				"Your cards are 7H 9D 4C AH 4S QC AD", "The top discard is JC" };
	...
	public void testPlayInvalidBasedOnDiscardCard() {
		String[] expected = new String[] { "Card was not valid for play. Please try again.", "Player 1, your turn.",
				"Your cards are QH JC 8S JD 10D 5H 3D", "The top discard is KC" };
		game.handleCommand("start-game 2 testDeck false");
	...
	public void testMultipleTurns2Players() {
		String[] expected1 = new String[] { "Card JC played.", "Player 2, your turn.",
				"Your cards are 7H 9D 4C AH 4S QC AD", "The top discard is JC" };
		String[] expected2 = new String[] { "Card QC played.", "Player 1, your turn.",
				"Your cards are QH 8S JD 10D 5H 3D", "The top discard is QC" };
		String[] expected3 = new String[] { "Card QH played.", "Player 2, your turn.",
				"Your cards are 7H 9D 4C AH 4S AD", "The top discard is QH" };
		String[] expected4 = new String[] { "Card 7H played.", "Player 1, your turn.",
				"Your cards are 8S JD 10D 5H 3D ", "The top discard is 7H" };
		game.handleCommand("start-game 2 testDeck false");
	...
	public void testMultipleTurns3Players() {
		String[] expected1 = new String[] { "Card 6S played.", "Player 2, your turn.",
				"Your cards are 7H 8S AH 5H AD 2S QD", "The top discard is 6S" };
		String[] expected2 = new String[] { "Card 2S played.", "Player 3, your turn.",
				"Your cards are JC 4C 10D QC KC 3C 5C", "The top discard is 2S" };
		String[] expected3 = new String[] { "Card 6D was drawn.", "Player 3, your turn.",
				"Your cards are JC 4C 10D QC KC 3C 5C 6D", "The top discard is 2S" };
		String[] expected4 = new String[] { "Card 3S was drawn.", "Player 3, your turn.",
				"Your cards are JC 4C 10D QC KC 3C 5C 6D 3S", "The top discard is 2S" };
		String[] expected5 = new String[] { "Card 3S played.", "Player 1, your turn.",
				"Your cards are QH 9D JD 4S 3D KD", "The top discard is 3S" };
	...
	public void testStartGameThreePlayers() {
		String[] expected = new String[] { "Cards dealt.", "Player 1, your turn.",
				"Your cards are QH 9D JD 4S 3D KD 6S", "The top discard is 7S" };
	...
	private void testGame(String name) {
		...
		try {
			...
			while (exampleGame.hasNextLine()) {
				...
				;
				if (line.startsWith("start-game") || line.startsWith("play-card") || line.startsWith("draw-card")
	...
	public void testStartGameFourPlayers() {
		String[] expected = new String[] { "Cards dealt.", "Player 1, your turn.",
				"Your cards are QH 8S 10D 3D 2S 5C AS", "The top discard is 2D" };
	...
	public void testStartGameOnePlayer() {
		String[] expected = new String[] { "Incorrect number of players, must be between 2 and 4." };
	...
	// new tests by Group 41
	@Test
	public void testshufflefunction() {
		String[] expected = new String[] { "Cards dealt.", "Player 1, your turn.",
				"Your cards are QH JC 8S JD 10D 5H 3D", "The top discard is KC" };
		String[] result = game.handleCommand("start-game 2 testDeck true").split("\n");
		assertEquals(expected[0], result[0]);
		assertEquals(expected[1], result[1]);
		assertNotEquals(expected[2], result[2]);
		assertNotEquals(expected[3], result[3]);
	}

	@Test
	public void testStandardDeck() {
		String[] expected = new String[] { "Cards dealt.", "Player 1, your turn.",
				"Your cards are AH 3H 5H 7H 9H JH KH", "The top discard is 2D" };
		String[] result = game.handleCommand("start-game 2 false").split("\n");
		compareStringArrayResults(expected, result);
		String[] result2 = game.handleCommand("start-game 2 standardDeck false").split("\n");
		compareStringArrayResults(expected, result2);
	}

	@Test
	public void testInvalidDeckText() {
		String[] expected = new String[] { "Please check the input!" };
		String[] result = game.handleCommand("start-game 2 invalidDeck false").split("\n");
		compareStringArrayResults(expected, result);
	}
