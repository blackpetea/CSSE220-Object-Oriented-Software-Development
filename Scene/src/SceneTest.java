...
public class SceneTest {
	...
	public void testSceneDrawing() {
		/*
		File temp = new File("src\\comparisonResult-scene.png");
		if (temp.exists()) {
			temp.delete();
		}
		...
		try {
			expected = ImageIO.read(new File("src/expected-scene.png"));
		...
		if (failed) {
			try {
				ImageIO.write(comparisonImage, "png", new File("src\\comparisonResult-scene.png"));
				System.out.println("Comparison failed, see src\\comparisonImage-scene.png for more details. "
	...
	private class TestComponent extends JComponent {
		...
		public void paintComponent(Graphics g) {
			...
			//draws a rectangle around the new sun in a particular position
