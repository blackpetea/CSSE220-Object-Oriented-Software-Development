...
public class Mushroom extends Creature implements Drawable, Temporal, Relocatable {
	...
	public BufferedImage getImage() {
		...
		if (this.isPostioned) {
			this.image = FileHandler.getImageFile("poisonmushroomL"+Integer.toString(currentDiff)+Integer.toString(this.destruction));
		} else {
			this.image = FileHandler.getImageFile("mushroomL"+Integer.toString(currentDiff)+Integer.toString(this.destruction));
		}
		return this.image;
	}
