package chessPieces;
import chessSupport.BoardLayoutProvider;
import chessSupport.ChessBoard;

public class AlbinProvider implements BoardLayoutProvider {
...
//		chessBoard[2][3] = new Pawn(false);
//		((Pawn)chessBoard[2][3]).setHasMovedTrue();
//		chessBoard[3][3] = new Pawn(false);
//		((Pawn)chessBoard[3][3]).setHasMovedTrue();
...
//		chessBoard[3][4] = new Pawn(true);
//		((Pawn)chessBoard[3][4]).setHasMovedTrue();
//		chessBoard[4][4] = new Pawn(true);
//		((Pawn)chessBoard[4][4]).setHasMovedTrue();
