...
public class DrawComponent extends JComponent {
	...
	public void addCircle(int x, int y, int radius, Color c) {
	...
	public void addSquare(int x, int y, int heightAndWidth, Color c) {
		...
		shapes.add(new Rectangle2D.Double(x-halfHeightWidth, y- halfHeightWidth, halfHeightWidth, halfHeightWidth));
		colors.add(c);
	}
