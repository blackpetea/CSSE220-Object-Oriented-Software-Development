...
public class MinesweeperGameTest {
	...
	public void testHasMine(){
		String[] board = {"   ", " X ", "   "};
		boolean[][] res={{false,false,false},{false,true,false},{false,false,false}};
		MinesweeperGame newGame=new MinesweeperGame(res);
		this.assertHasMines(board, newGame);
	}
	...
	public void testGetNeighborMineCount(){
		...
		boolean[][] res={{false,false,false},{false,true,false},{false,false,false}};
		MinesweeperGame newGame=new MinesweeperGame(res);
		this.assertGetNeighborMineCount(board, boardResults, newGame);
	}
