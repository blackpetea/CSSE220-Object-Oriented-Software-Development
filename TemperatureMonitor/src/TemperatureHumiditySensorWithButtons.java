...
public class TemperatureHumiditySensorWithButtons 
	 ...
	 */
	public TemperatureHumiditySensorWithButtons(
			ErrorReporter errorHandler, String labName, double minTemp, double maxTemp, double minHumid, double maxHumid){
		super(labName, minTemp, maxTemp, minHumid, maxHumid);
