 ...
 * 
 * People should be sorted first by their last name, then by their age. So the
 * output of the sample main should be:
 * 
...
public class Person implements Comparable<Person> {
	...
	public int compareTo(Person arg0) {
		...
		int stringResult = this.lastName.compareTo(arg0.lastName);
		if (stringResult != 0) {
			return stringResult;
		}
